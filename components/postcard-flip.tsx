        ...
        >
          ...
          <div className="absolute inset-0 w-full h-full backface-hidden rounded-2xl shadow-2xl overflow-hidden bg-white border-4 border-white">
            <div className="relative w-full h-full">
              <img
                src="/images/ogi-postcard.png"
                alt="Postcard with memories and annotations for Kak Ogi"
          ...
          <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-2xl shadow-2xl bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 p-6 overflow-y-auto border-4 border-white">
            <div className="h-full flex flex-col">
              ...
              <div className="flex-1 space-y-4">
                ...
                <p>
                  Jujur kita baru ngobrol deket kemarin di cafe sih kak, tapi aku seneng banget bisa kenal lebih deket sama kakak.
                </p>

                <p>
                  Semangat ya buat adik kakak, semoga diterima di PTN yang bagus dan bisa banggain kakak. Aku yakin dengan support
                  kakak, adik kakak pasti tambah semangat juga.
                </p>

                <p>
                  Kakak semangat juga belajar bahasa Inggrisnya! Step by step aja, pasti bisa kok, yang penting konsisten. Nanti
                  tiba-tiba udah lancar wkwk, mungkin bisa jauh lebih dari aku.
                </p>

                <p>
                  Kalau butuh apa-apa kakak bisa chat juga sih hwhw, entah itu buat nanya, cerita, atau sekadar random talk aja.
                  Aku open banget hehe.
                </p>

                <p>
                  Pokoknya sukses terus ya kak, semoga apa yang kakak impiin bisa tercapai. Keep positive, tetep jadi diri sendiri,
                  dan jangan lupa juga have fun di tengah kesibukan. Semoga kita bisa sering ngobrol lagi ke depannya!!!!
                </p>

                <p>
                  Semoga langgeng sama pacar kakak dan bisa ikhlas apapun hal buruk yang udah terjadi dan mungkin terjadi nanti :)
                </p>

                <p>
                  Selamat menempuh umur 28 kak!!! SEMOGA TAHUN INI DAN DEPAN JADI TAHUN KAKAK!!!
                </p>
